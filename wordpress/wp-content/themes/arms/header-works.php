...
<html>
  ...
  <body class="<?= wp_title() ?> works md:h-screen md:overflow-y-hidden">
    <header
      class="fixed h-48 md:h-1/4 flex flex-row items-center justify-between px-12 sm:px-24 left-0 top-0 right-0 z-20 pointer-events-none bg-arms-black light"
    >
      <div>
